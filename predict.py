...
import torchvision.models as models
from DL_ESUN_public_main import model as m
from collections import namedtuple
...
IN_FEATURES = pretrained_model.fc.in_features
fc = nn.Linear(IN_FEATURES, OUTPUT_DIM)
model = m.ResNet(resnet50_config, OUTPUT_DIM)

check_point = 'model_weights/resnet50_model_256_0.5047058375149713.pt'
...
# if model_name == 'CoAnet_bal5000':
#     check_point = 'model_weights/CoAnet_bal5000_model_256_0.23246576046939518.pt'
    
# elif model_name == 'CoAnet50_aug3000':
#     check_point = 'model_weights/CoAnet50_aug3000_model_256_0.2056291450221731.pt'
    
# elif model_name == 'CoAnet50':
#     check_point = 'model_weights/CoAnet50_model_256_0.22217776313673637.pt'
